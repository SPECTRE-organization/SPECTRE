...
{    
     pressure = printCompensatedMeasurements(1);
            ...
            Serial.print("\tAltitudeThreshold: ");
    ...
    if(initial_pressure-pressure < altitude_threshold)
    {
       stop_timer = true;
    }    
    if(initial_pressure-pressure > 0.01  && Handup == true)
    {
       stop_timer = true;       
    }    
    if(initial_pressure-pressure > altitude_handup  && Handup == true)
    {
       Handdown   = true;
    }
    if(initial_pressure-pressure <= 0.01  && Handdown == true)
    {
       delay(500);
       Handdown   = false;
    }

    if(initial_pressure-pressure >= altitude_threshold  && initial_pressure-pressure <= altitude_handup)
    {
       stop_timer = false;
    }
